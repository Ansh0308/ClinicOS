        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start">
              <button className="btn-primary text-sm py-3.5 px-8">
                Get Started
                <ArrowRight size={16} />
              </button>
             ...
             <div className="flex items-center gap-4 mt-8 justify-center lg:justify-start">
              <div className="flex -space-x-2">
                 {['bg-crimson-400','bg-accent-teal','bg-accent-yellow','bg-accent-lavender'].map((bg, i) => (
                  <div key={i} className={`w-8 h-8 ${bg} rounded-full border-2 border-cream-50 flex items-center justify-center text-xs text-white font-bold`}>
               ...
               <div>
                <div className="flex gap-0.5">
                  {[1,2,3,4,5].map(s => <Star key={s} size={14} className="fill-accent-yellow text-accent-yellow" />)}
                </div>
  ...
  return(
    <div className="card shadow-hero p-0 overflow-hidden">
      ...
      <div className="p-4 space-y-2">
        {Queue.map((t) => (
          <div key={t.num} className="flex items-center gap-3 p-3 rounded-2xl bg-cream-50 border border-cream-200 hover:border-cream-300 transition-colors">
...
const FEATURES = [
  {
    ...
    description: 'Real-time token board with ETA predictions. Staff issue tokens in one tap. Patients see live status on their phone.',
  ...
  },
  {
    ...
    description: 'Every visit, prescription, complaint and bill — searchable in under 5 seconds. No more hunting through paper files.',
  ...
  },
  {
    ...
    description: 'WhatsApp, SMS, and Email sent automatically. Token issued, queue reminders, bill receipts — zero manual effort.',
  ...
  },
  {
    ...
    description: 'Create bills in seconds. Payment recorded, PDF receipt auto-sent to patient\'s WhatsApp. Full audit history.',
  ...
  },
  {
    ...
    description: 'Revenue, patient throughput, wait times — all live. Clinic owners see the full picture without asking staff.',
  ...
  },
  {
    ...
    description: 'DPDP-compliant patient consent. Role-based access so staff only see what they need. Audit log on every action.',
       ...
       <div className="section-container">
        <div className="nav-gradient rounded-3xl p-12 text-center shadow-hero">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button className="btn-cta px-10 py-4 text-sm">
              Way to Smart Clinic
              <ArrowRight size={16} />
            </button>
          </div>
